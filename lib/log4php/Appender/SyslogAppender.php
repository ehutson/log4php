...
namespace log4php\Appender;

use log4php\LoggerAppender,
    log4php\LoggerLoggingEvent;
 ...
 */
class SyslogAppender extends LoggerAppender
{
        ...
        foreach ($options as $option) {
            if (!empty($option)) {
                ...
                if (defined($constant)) {
                    ...
                    trigger_error("log4php: Invalid syslog option provided: $option. Whole option string: {$this->option}.",
                                  E_USER_WARNING);
                }
            }
        }
    ...
    private function parseFacility()
    {
        if (!empty($this->facility)) {
            ...
            if (defined($constant)) {
                ...
                trigger_error("log4php: Invalid syslog facility provided: {$this->facility}.",
                              E_USER_WARNING);
            }
        }
    }
    ...
    private function parsePriority()
    {
        if (!empty($this->priority)) {
            ...
            if (defined($constant)) {
                ...
                trigger_error("log4php: Invalid syslog priority provided: {$this->priority}.",
                              E_USER_WARNING);
            }
        }
    }
