...
class Logger
{
    ...
    private static function getConfigurator($configurator = null)
    {
        if ($configurator === null) {
            return new Configurator\DefaultAdapter();
        }
        ...
        if (is_object($configurator)) {
            if ($configurator instanceof LoggerConfigurator) {
                ...
                trigger_error("log4php: Given configurator object [$configurator] does not implement the LoggerConfigurator interface. Reverting to default configurator.",
                              E_USER_WARNING);
                return new Configurator\DefaultAdapter();
            }
        }
        ...
        if (is_string($configurator)) {
            if (!class_exists($configurator)) {
                trigger_error("log4php: Specified configurator class [$configurator] does not exist. Reverting to default configurator.",
                              E_USER_WARNING);
                return new Configurator\DefaultAdapter();
            }
            ...
            if (!($instance instanceof LoggerConfigurator)) {
                trigger_error("log4php: Specified configurator class [$configurator] does not implement the LoggerConfigurator interface. Reverting to default configurator.",
                              E_USER_WARNING);
                return new Configurator\DefaultAdapter();
            }
        ...
        trigger_error("log4php: Invalid configurator specified. Expected either a string or a LoggerConfigurator instance. Reverting to default configurator.",
                      E_USER_WARNING);
        return new Configurator\DefaultAdapter();
    }
