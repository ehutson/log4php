...
use log4php\Configurator\Adapter,
    \log4php\LoggerException;
 ...
 * @since 2.2
 */
class LoggerConfigurationAdapterINI implements Adapter
{
    ...
    public function convert($path)
    {
        ...
        if (isset($properties[self::ROOT_LOGGER_PREFIX])) {
            $this->parseLogger($properties[self::ROOT_LOGGER_PREFIX],
